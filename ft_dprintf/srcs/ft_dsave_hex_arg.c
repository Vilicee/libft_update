...
/*   Updated: 2021/09/10 13:42:00 by wvaara           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_part_two(t_data *data)
{
	if (data->ll == 1)
	{
		...
		data->len = ft_dhexa_len(data, data->ulln);
		if (data->ulln == 0)
			data->d_zero = 1;
	}
	if (data->ll == 0 && data->l == 0 && data->h == 0 && data->hh == 0)
	{
		...
		data->len = ft_dhexa_len(data, data->un);
		if (data->un == 0)
			data->d_zero = 1;
	}
}
...
void	ft_dsave_hex_arg(t_data *data)
{
	if (data->h == 1)
	{
		...
		data->len = ft_dhexa_len(data, data->uhn);
		if (data->uhn == 0)
			data->d_zero = 1;
	}
	if (data->hh == 1)
	{
		...
		data->len = ft_dhexa_len(data, data->ohhn);
		if (data->ohhn == 0)
			data->d_zero = 1;
	}
	if (data->l == 1)
	{
		...
		data->len = ft_dhexa_len(data, data->uln);
		if (data->uln == 0)
			data->d_zero = 1;
	}
	ft_part_two(data);
